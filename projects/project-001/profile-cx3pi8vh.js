import{r as w,j as e,ac as N,aa as L,T,a as y,ai as S,ab as B}from"./index-CaqiBWD3.js";import{A as D}from"./leftSidebar-DKx4Mb0R.js";import{k as C,w as b,C as i,B as d,D as h,ax as M,F as l,M as A,I as j,ay as E,az as $,d as q,f as z}from"./editorApp-DZMui-50.js";import{T as K}from"./index-BzblAUWm.js";import{T as U,R as O,M as _}from"./index-9gNDCDRB.js";import"./Styles-BsfcSZ3N.js";const{Paragraph:V}=U,g=({title:r,fieldKey:s,fieldvalue:a})=>{const[x,c]=w.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"ghostTag",children:r}),e.jsx(V,{editable:{icon:x?e.jsx(T,{}):e.jsx(O,{}),onChange:p=>{c(!0),M({[s]:p}).finally(()=>{c(!1)})}},children:a})]})},H=()=>{const r=C(u=>u.user),[s,a]=w.useState(!1),x=()=>{const[u,P]=w.useState(!1),[v]=l.useForm();function k(t){P(!0),$(t).then(()=>{y.success("Password changed"),a(!1)}).catch(o=>{y.warning("Something went wrong"),console.log(o)}).finally(()=>{P(!1)})}return e.jsx(A,{title:"Change password",open:!0,okText:"Change Password",onOk:()=>{v.submit()},okButtonProps:{loading:u},onCancel:()=>{a(!1)},children:e.jsxs(l,{disabled:u,form:v,layout:"vertical",name:"basic",initialValues:{remember:!0},onFinish:k,autoComplete:"off",children:[e.jsx(l.Item,{label:"Current Password",name:"currentPassword",rules:[{required:!0,message:"Please input current password!"}],children:e.jsx(j.Password,{})}),e.jsx(l.Item,{hasFeedback:!0,dependencies:["currentPassword"],label:"New Password",name:"newPassword",rules:[{required:!0,message:"Please input new password!"},({getFieldValue:t})=>({validator(o,f){return t("currentPassword")!==f?Promise.resolve():Promise.reject(new Error("New password should not be the same as current one."))}}),()=>({validator(t,o){return E(o)}})],children:e.jsx(j.Password,{})}),e.jsx(l.Item,{label:"Repeat New Password",name:"repeatNewPassword",dependencies:["newPassword"],hasFeedback:!0,rules:[{required:!0,message:"Please confirm your password!"},({getFieldValue:t})=>({validator(o,f){return!f||t("newPassword")===f?Promise.resolve():Promise.reject(new Error("The two passwords that you entered do not match!"))}})],children:e.jsx(j.Password,{})})]})})};if(!r)return null;const{email:c,blocked:p,confirmed:m,firstName:I,lastName:F,company:R}=r;return e.jsxs(e.Fragment,{children:[e.jsxs(b,{children:[e.jsxs(i,{span:8,children:[e.jsx("div",{className:"ghostTag",children:"email"}),c,e.jsx(K,{style:{padding:3,borderRadius:10,lineHeight:"1em",marginBottom:5,marginLeft:5,fontSize:10},icon:m?e.jsx(N,{style:{marginRight:-5}}):e.jsx(L,{style:{marginRight:-5}}),color:m?"success":"warning",children:m?"Confirmed":"Not confirmed"}),!m&&e.jsx("div",{style:{marginTop:10},children:e.jsx(d,{type:"primary",children:"Confirm Email"})})]}),e.jsxs(i,{span:8,children:[e.jsx("div",{className:"ghostTag",children:"account status"}),p?"Blocked":"Active"]}),e.jsxs(i,{span:8,children:[e.jsx("div",{className:"ghostTag",children:"password"}),e.jsx(d,{onClick:()=>{a(!0)},children:"Change password"})]})]}),e.jsx(h,{}),e.jsxs(b,{children:[e.jsx(i,{span:8,children:e.jsx(g,{title:"First name",fieldKey:"firstName",fieldvalue:I})}),e.jsx(i,{span:8,children:e.jsx(g,{title:"Last name",fieldKey:"lastName",fieldvalue:F})}),e.jsx(i,{span:8,children:e.jsx(g,{title:"Company",fieldKey:"company",fieldvalue:R})})]}),s&&e.jsx(x,{})]})},W=S.div`
  position: relative;
  display: flex;
  align-items: stretch;
  height: 100%;
